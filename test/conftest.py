def pytest_addoption(parser):
    """Parses CLI arguments to run specific (groups of) tests. Running: python.

    -m pytest runs the default tests pertaining to the main code of this
    project. Including the argument --ggl runs the main code tests as well as
    tests that pertain to the Google Style Guide for Bash conventions.
